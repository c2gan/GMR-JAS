...
#alp_int<-c(0.6,0.4)
alp_int<-c(0.75,0.25)
#beta_int<-cbind(c(30,0),c(40,0.5)) 
#beta_int<-cbind(c(10,0),c(20,0.5)) 
#try different sets of initial values and select the estimates that achieve the highest log likelihood.
...
#beta_int<-cbind(c(20,0.5),c(10,0.8),c(0,0.3))
...
#beta_int<-cbind(c(20,0.2),c(10,0.2),c(0,0.2))
...
#beta_int<-cbind(c(20,0.2),c(10,0.2),c(0,0.2),c(30,0.2))
...
#beta_int<-cbind(c(20,0.2),c(10,0.2),c(0,0.2),c(30,0.2),(100,0,2))
...
#G=7
#alp_int<-c(0.02,0.08,0.1,0.15,0.15,0.2,0.3)
...
#beta_int<-cbind(c(180,0),c(150,0),c(120,0),c(100,0),c(60,0),c(30,0),c(0,0))
#beta_int<-cbind(c(200,0,2),c(100,0.2),c(60,0.2),c(80,0.2),c(20,0.2),c(40,0.2))
...
#beta_int<-cbind(c(40,0.2),c(50,1.5),c(30,0),c(120,0.1),c(60,0),c(100.5,0.16),c(80,0.1),c(120,0))
...
#beta_int<-cbind(c(180,0),c(150,0),c(120,0),c(100,0),c(60,0),c(30,0),c(70,0),c(20,0))
#beta_int<-cbind(c(200,0,2),c(100,0.2),c(60,0.2),c(80,0.2),c(20,0.2),c(40,0.2),c(0,0.2))
